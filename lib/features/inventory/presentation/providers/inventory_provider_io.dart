...
import 'inventory_provider_stub.dart' if (dart.library.html) 'inventory_provider_web.dart';
...
class InventoryNotifier extends StateNotifier<List<InventoryItem>> {
  ...
  Future<void> addItem(InventoryItem item) async { state = [...state, item]; await _saveToStorage(); }
